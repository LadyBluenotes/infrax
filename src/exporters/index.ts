...
function generateHeader(
  ...
  const lines = [
    `Generated by switchboard v${resolved.meta.version}`,
    `Config hash: ${resolved.meta.configHash}`,
    `Generated at: ${resolved.meta.timestamp}`,
    ``,
    `DO NOT EDIT THIS FILE DIRECTLY.`,
    `Edit your ai.config.jsonc and run 'switchboard export' instead.`,
  ];
...
export function exportMcp(
  ...
  const outputConfig = {
    _generated: {
      by: `switchboard v${resolved.meta.version}`,
      hash: resolved.meta.configHash,
      at: resolved.meta.timestamp,
      warning: "DO NOT EDIT. Run 'switchboard export mcp' to regenerate.",
    },
    ...config,
  };
